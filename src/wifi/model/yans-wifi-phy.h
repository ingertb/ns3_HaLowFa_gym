...
public:
  ...
  void SetSinrDiffCapture (double sinr);
  double GetSinrDiffCapture (void) const;
  /**
...
void Configure80211ah (void);
  ...
  Ptr<InterferenceHelper::Event> m_rxPacketEvent;
  bool m_doDataCapture;
  bool m_doPreambleCapture;
  Time m_rxDuration;
  Time m_rxDurationOfCapturedPacket;
  double SinrDiffCapture;
};
